...
//http://www.otusanalytics.com/flotr2_bar_charts.html
//http://gnuhaus.com/flotr2Configurator/bargraph.php
     ...
     /* for (var i = 0; i < sampleSize; i++) {
      ...
      for (var i = 0; i < keyArray.length; i++) {
       console.log( keyArray[i] + " : " + probabilityMap[keyArray[i]]);
        d6[i]=[parseFloat(keyArray[i]), probabilityMap[keyArray[i]]]
      };
      ...
      //d7 = [[10,0]]
      wins = [[1.5,1.67],[2,1.67],[3.5,1.67],[4.3,1.67],[5.2,1.67],[6,1.67]];
      data = [
        {data : d6},
      //  {data : d2},
